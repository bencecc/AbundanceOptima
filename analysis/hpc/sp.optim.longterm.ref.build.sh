...
#echo "apptainer exec --bind ${HOME}:${HOME} ${my_container}/stats.sif Rscript ${my_scripts}/sp_optimloc_ecoreg_longterm_ref_build.R ${P1} ${P2}" 
apptainer exec --bind ${HOME}:${HOME} ${my_container}/stats.sif Rscript ${my_scripts}/sp_optimloc_ecoreg_longterm_ref_build.R ${P1} ${P2} 
...
done < ${my_indices}/id.optim.abund.firstsite.longterm.txt
