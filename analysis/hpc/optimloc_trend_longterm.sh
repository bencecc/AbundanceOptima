...
#echo "apptainer exec --bind ${HOME}:${HOME} ${my_container}/stats.sif Rscript ${my_scripts}/optimloc_ecoregion_trend_longterm.R ${P1} ${P2} ${P3} ${P4} ${P5}"
apptainer exec --bind ${HOME}:${HOME} ${my_container}/stats.sif Rscript ${my_scripts}/optimloc_ecoregion_trend_longterm.R ${P1} ${P2} ${P3} ${P4} ${P5} 
